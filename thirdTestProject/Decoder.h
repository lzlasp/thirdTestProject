...
public:
	...
	*	Retruns the number of samples read, or zero if the stream has ended.
	*/
	...
	*	'secondslimit' - number of seconds to devoe to caculation an estimate, or 0 to perform a complete calculation.
	*/
